...
[README (English)](https://github.com/justfont/jf7000?tab=readme-ov-file#jf-7000-Character-Set) /  [README (繁體中文)](https://github.com/justfont/jf7000?tab=readme-ov-file#jf-7000-%E7%95%B6%E5%8B%99%E5%AD%97%E9%9B%86)


# jf 7000 Character Set

[![CC BY-SA 4.0][cc-by-sa-shield]][cc-by-sa]


**jf 7000 - A Traditional Chinese Character Set designed for Taiwan**

The *jf 7000 Traditional Chinese Character Set* is collected and released by justfont. Tailored to meet the specific needs of Taiwanese users, the character set focuses on the 7,000 most commonly used Traditional Chinese characters. It also includes expansion packs for various purposes, creating a balanced typeface that supports both basic use and flexible expansion. 
...
> What character set should you use for font creation a Traditional Chinese font? 

This is a common challenge faced by independent designers working with justfont.

A “character set” defines how many and which characters are required for a font. The most widely used Traditional Chinese character set, Big5, includes over 13,000 characters to cover a wide range of scenarios. 
...
- Read more: [A Beginner’s Guide to Chinese Characters Sets | justfont blog](https://blog.justfont.com/2025/02/chinese-character-sets-en/)

Moreover, not all fonts are designed with body text typesetting as the goal. Character set selection should also offer a simplified and flexible solution. Therefore, we have refined and organized a “Core Set” of about 7,000 characters and categorized additional sets (such as local language characters, commonly used naming characters, etc.) into “Extension Packs”. 

We introduce the jf 7000 Character Set, which is open-source and free for use. We hope this will support independent designers and make the font creation journey smoother.

![](assets/range.jpg)

## Core Set & Extension Packs

The jf 7000 Character Set is divided into “Core Set” and Extension Packs”. 

The Core Package includes essential characters, which, when completed, will cover most scenarios in Taiwan. The Extension Packages include **Formosan Languages Pack**, **Taiwan Naming Pack**, **Japanese Common Pack**, **HK & MO Common Pack** and **Symbol Pack**, for designers to freely select.

- Read more: [jf 7000: A Smarter Open-Sourced Chinese Character Set | justfont blog](https://blog.justfont.com/2025/04/jf7000-en/)

## Inclusion Criteria

The project is led by the justfont team, with editorial committee members including [Zhi-Jie Ko](https://github.com/ButTaiwan) (also known as [Iansui](https://github.com/ButTaiwan/iansui) and moderator of facebook group 字嗨), and Kiàn-Tiong Tân, Taigi consultant for multiple justfont fonts.

The inclusion principles include common characters from the Ministry of Education’s list and shared characters from major font companies. Additional characters such as Taiwanese place names, university entrance examination lists, and commonly used characters in daily life are also included.
...
The jf 7000 Character Set hopes to not only be based on common language or frequency but also on “functionality.” Therefore, we look forward to inviting experts from various fields to contribute professional character suggestions and help organize specialized character sets, providing designers with guidance and expanding the possibilities for future font proposals in Taiwan.

- Help us organize bird-related character names! Possible bird characters: `鸌`, `鳦`, `鳱`, `鳾`, `鵷`, `鷚`, `䴉`, etc.

- Help us organize related terminology characters! Possible chemistry characters: `苄`, `醌`, `焓`, `鋞`, `呋`, and elements from the periodic table.

- Help us organize commonly used characters from ancient texts! Possible ancient literature characters: `邙`, `譖`, `敧`, `詘`, `跽`, `鏦`, `饘`, etc.

As of March 2025, suggestions from community experts are summarized in the table below, including “Fanbase Support Pack,” “Chemistry Pack,” and “Ecology Pack.” Please visit the Extension Packs Page for more details.

If you would like to contribute to a specialized character set, please continue to submit your feedback. Once we receive your reply, the team will review it and notify you of any updates. If your suggestion is adopted, we will credit you as a contributor and update the list accordingly.

<div align="center">

[![](https://img.shields.io/badge/Submit_a_Contributionons-F5822A?style=for-the-badge&logo=typer)](https://justfont.typeform.com/to/STrVxvdD?_gl=1*137y5eg*_gcl_au*MTQwODQ1MjgyOS4xNzIxMzc1ODE3*_ga*NzY4MzcwNDk4LjE3MTI3NjE1Njc.*_ga_L3HTQBC4VD*MTcyMTcxODgxMS4yOS4xLjE3MjE3MTk1MDEuNTkuMC4w&_ga=2.101642689.1318679437.1721718812-768370498.1712761567)

</div>

## Release & Download

All future justfont products will support the Core Set range. Past font products will gradually update for supporting Core Set.

Currently, the released file is a Glyphs character filter that can only be used in [Glyphs.app](https://glyphsapp.com/). Since some characters in the set do not have dedicated Unicode encoding, we present the list in a format to prevent character loss.

If you're not using Glyphs, you can also access the spreadsheet or download plain text files to browse the character set packages and quickly search for specific characters. However, please note that due to encoding issues, directly copying from the webpage or text version will result in some characters being omitted. It is recommended for reference only.

<div align="center">

[![https://docs.google.com/spreadsheets/d/1yI9O2_nlEjP28McIXPJS8GO2U9yVBbnZIvlDFyCKV18/edit?usp=sharing](https://img.shields.io/badge/View_spreadsheet-34A853?style=for-the-badge&logo=googlesheets&logoColor=f5f5f5)](https://docs.google.com/spreadsheets/d/1yI9O2_nlEjP28McIXPJS8GO2U9yVBbnZIvlDFyCKV18/edit?usp=sharing/) 

[![https://github.com/justfont/jf7000/releases](https://img.shields.io/badge/Download_text_files-181717?style=for-the-badge&logo=github)](https://github.com/justfont/jf7000/releases)

</div>

## Badges

You can add a badge to your repo if your font supports the jf 7000 Character Set. Here are some examples, feel free to modify the badge based on the level of support your font ranges.

[![jf 7000: Core Set Supported](https://img.shields.io/badge/jf_7000-Core_Set_Supported-66AC35?logo=data:image/svg+xml;base64,&style=flat-square)](https://github.com/justfont/jf7000)
...
We hope this project can become a helpful resource for independent font creators. If you have any questions or doubts about using the character set, please feel free to contact us at just@justfont.com.
...
「字集」規範了一套字型要做多少字、有哪些字。目前最通行的繁中字集 Big5 為求能支援絕大多場合，收錄字數高達 13,000 以上。字數雖多，其中卻包含許多罕用字，也因年代久遠，缺少如 `獴`、`蟎`、`㹴` 等現代常用字，如果依表造完往往事倍功半。

- 延伸閱讀：[下載字型前先看｜為什麼會缺字？ | justfont blog](https://blog.justfont.com/2023/06/charactersets/)
...
- 延伸閱讀：[隆重宣佈｜jf 7000 當務字集公開測試中！ | justfont blog](https://blog.justfont.com/2023/07/jf7000/)
...
收錄原則包含教育部常用字表及各大字型公司之共通字，另也補充收錄字如台灣地名路名、大考中心榜單與生活常見用字等。各語言、符號及命名常用字則由計畫團隊彙整編輯。詳細收錄規範與介紹請至 justfont blog 專文閱讀。
...
目前釋出之檔案為 Glyphs 字集清單 ，需於 [Glyphs](https://glyphsapp.com/) 中方可使用。因字集內有部分字符沒有專屬 Unicode 編碼（[延伸閱讀：Unicode 簡介](https://learn.justfont.com/pocketbook/font-tech/unicode)），故需以清單格式呈現避免字符遺漏。
...
如果你的字體涵括 jf 7000 當務字集，歡迎在說明中加入標示。你可以參考以下的範例，根據字符範圍的支援程度修改標示。
...
盼此計畫能成為獨立設計師造字路上的助力。若在使用上遇到任何疑惑，都歡迎來信 [just@justfont.com](mailto:just@justfont.com) 聯絡洽詢。

---

# 關於 justfont / About justfont
